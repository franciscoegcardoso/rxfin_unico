...
import { ExternalLink, ChevronRight, Monitor, FileText, Download, CheckCircle2, HelpCircle, X } from 'lucide-react';
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <Button
            size="sm"
            className="shrink-0"
            onClick={() => window.open('https://mir.receita.fazenda.gov.br/portalmir/listar-documentos/', '_blank')}
          >
            Acessar
