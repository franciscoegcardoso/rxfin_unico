/**
 * Audit log standalone — para uso em services/utilitários fora de React.
 * Nunca deve quebrar a aplicação; falhas são apenas logadas no console.
 */
import { supabase } from '@/integrations/supabase/client';

export interface LogCrudParams {
...
export async function logCrudOperation(params: LogCrudParams): Promise<void> {
  try {
