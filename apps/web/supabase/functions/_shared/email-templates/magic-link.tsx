  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>Clique no botão abaixo para acessar sua conta no <strong>RXFin</strong>:</Text>
        <Section style={buttonSection}>
          <Button style={button} href={confirmationUrl}>Entrar no RXFin</Button>
        </Section>
        {token && (
          <>
            <Text style={textMuted}>Ou use este código temporário:</Text>
            <code style={code}>{token}</code>
          </>
        )}
        <Hr style={hr} />
        <Text style={footer}>Se você não solicitou este acesso, ignore este email.</Text>
