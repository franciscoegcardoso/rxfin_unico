  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Confirme seu email ✉️</Heading>
        <Text style={text}>
          Obrigado por se cadastrar no <strong>RXFin</strong>! Confirme seu email clicando no botão abaixo:
        </Text>
        ...
        {token && (
          <>
            <Text style={textMuted}>Ou use este código de verificação:</Text>
