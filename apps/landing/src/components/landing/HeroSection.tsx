...
export const HeroSection: React.FC<HeroSectionProps> = ({ onScrollToSystem }) => {
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center pt-20 pb-10 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-center lg:gap-12 xl:gap-16 w-full">
        ...
        >
          ...
          >
            <span className="block sm:inline-block sm:text-[1.7rem] lg:text-[2.45rem]">
              ...
              <span className="sm:inline">Evite erros caros.</span>
            </span>
          </motion.h1>
